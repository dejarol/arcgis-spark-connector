...
object BuildSupport {
  ...
  object constants {
    ...
    final lazy val SPARK_VERSION = "3.5.0"
    final lazy val STTP_VERSION = "4.0.0"
    final lazy val JSON4S_VERSION = "3.7.0-M11"
    final lazy val SCALA_TEST_VERSION = "3.2.20"

    final lazy val ORGANIZATION = "io.github.dejarol"
    final lazy val PROJECT_NAME = "arcgis-spark"
    final lazy val ARTIFACT_NAME = f"$PROJECT_NAME-connector"

    final lazy val PROJECT_URL = "https://github.com/dejarol/arcgis-spark-connector"
